...
extension Project {
  ...
  public static func app(name: String, product: Product, platform: Platform, dependencies: [TargetDependency] = []) -> Project {
    return self.project(name: name, product: product, platform: platform, dependencies: dependencies, infoPlist: [
